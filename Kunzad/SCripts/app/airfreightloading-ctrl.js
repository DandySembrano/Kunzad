kunzadApp.controller("AirFreightLoadingController", function ($rootScope, $scope, $http, $interval, $compile, $filter) {
    ...
    $scope.initCheckInDataGrid = function () {
        ...
        $scope.checkInResetData = function () {
            $scope.checkInItem = {
                "Id": null,
                "CheckInTypeId": 2, //Air freight loading Id
                "CheckInType": {
                    "Id": null,
                    "Name": null
                },
        ...
        $scope.checkInOtherActionsFiltering = function (action) {
            switch (action) {
                ...
                case 'PreFilterData':
                    ...
                    //CheckInTypeId for air freight loading
                    $scope.checkInFilteringDefinition.DataItem1.CheckIn[0].CheckInTypeId = 2;
    ...
    $scope.initCheckInShipmentsDataGrid = function () {
        $scope.initializeCheckInShipmentsDataDefinition = function () {
            $scope.checkInShipmentsDataDefinition = {
                ...
                "ContextMenu": ["'ShowShipmentDetails'"],
                "ContextMenuLabel": ['Show Details'],
                "IsDetail": true
            }
        };
